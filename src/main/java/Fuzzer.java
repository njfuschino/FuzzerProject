...
public class Fuzzer {
	...
	public void fuzz(String siteURL) throws FailingHttpStatusCodeException, MalformedURLException, IOException {
		discoverAttackSurface(siteURL);
		
		
	}
	
	private void discoverAttackSurface(String siteURL) throws FailingHttpStatusCodeException, MalformedURLException, IOException {
